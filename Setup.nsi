...
!addincludedir "..\NsisMultiUser\Demos\Common"
...
!define VERSION "5.3.2" ; main version of the application (may be 0.1, alpha, beta, etc.)
...
!define CONTACT "@ruddj" ; stored as the contact information in the uninstall info of the registry
!define COMMENTS "Sports Administrator carnival management software" ; stored as comments in the uninstall info of the registry
!define PRODUCT_FOLDER "SportsAdmin"
!define PRODUCT_WEB_SITE "https://github.com/ruddj/SportsAdmin"
!define URL_INFO_ABOUT "https://github.com/ruddj/SportsAdmin" ; stored as the Support Link in the uninstall info of the registry, and when not included, the Help Link as well
!define URL_HELP_LINK "https://github.com/ruddj/SportsAdmin/wiki" ; stored as the Help Link in the uninstall info of the registry
!define URL_UPDATE_INFO "https://github.com/ruddj/SportsAdmin" ; stored as the Update Information in the uninstall info of the registry
...
!define MUI_ICON "Sports.ico"
!define MUI_UNICON "Sports.ico"
...
; The file to write
OutFile "${PRODUCT_FOLDER}-v${VERSION}-Install.exe"
...
Section "Core Files (required)" SectionCoreFiles
	...
	; Fix Uninstall Icon
	WriteRegStr SHCTX "${MULTIUSER_INSTALLMODE_UNINSTALL_REGISTRY_KEY_PATH}" "DisplayIcon" "$INSTDIR\Sports.ico"
...
Section  /o "Desktop Icon" SectionDesktopIcon
	...
	!insertmacro MULTIUSER_GetCurrentUserString $0
	CreateShortCut "$DESKTOP\${PRODUCT_NAME}$0.lnk"  \
	  $AccessExe "/runtime $\"$INSTDIR\${PROGEXE}$\"" "$INSTDIR\Sports.ico" 0

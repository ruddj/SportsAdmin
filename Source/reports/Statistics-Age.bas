        ...
        Begin PageHeader
            ...
            Begin
                ...
                Begin Label
                    ...
                    FontWeight =700
                    Name ="Text102"
                    Caption ="Overall Statistical Summary - by Age Group"
                    FontName ="times New Roman"
                End
            End
        End
...
Const ReportTitle = "Overall Results - By Age"
Const repName = "age" ' Keep to 4 letters or less (and unique from all other reports
...
On Error Resume Next
    ...
    rHTML = rHTML & Heading(3, "AGE: " & Me!Age, 3)
    Call CellEnd(rHTML)
